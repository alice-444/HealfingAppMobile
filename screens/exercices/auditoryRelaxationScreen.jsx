...
const AuditoryRelaxation = ({ navigation }) => {
  const categories = [
    {
    ...
    {
      title: "Respir. et synchronisé avec des sons",
      image: require("../../assets/meditation.png"),
      navigateTo: "",
    },
    {
    ...
    {
      title: "Respir. et chants des mantras",
      image: require("../../assets/meditation.png"),
      navigateTo: "",
    },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.categoriesContainer}>
        <Text style={styles.title}>Relaxation auditive</Text>
...
export default AuditoryRelaxation;
